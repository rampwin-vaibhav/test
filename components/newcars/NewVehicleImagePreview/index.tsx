...
import { NewImagePreviewThumb } from './NewImagePreviewThumb';
...
type NewVehicleImagePreviewPropType = {
...
const NewVehicleImagePreview: React.FC<NewVehicleImagePreviewPropType> = ({
  images,
  dir,
  show,
  onClose,
...
export default NewVehicleImagePreview;
