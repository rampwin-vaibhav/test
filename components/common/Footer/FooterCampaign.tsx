...
import { TelephoneIcon, EmailIcon } from '../../icons';
...
const FooterCampaign: FC<ChildProps> = ({
  careerEmail,
  socialMedia,
  phoneNumber,
}): ReactElement => {
          ...
          <div className="ml-0 md:ml-20 flex flex-col gap-[1.438rem] items-center md:items-start">
            ...
            <div className="flex gap-5">
              ...
              >
                <picture>
                  <source
                    srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/fb.svg`}
                    type="image/svg"
                  />
                  <img
              ...
              >
                <picture>
                  <source
                    srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/youtube.svg`}
                    type="image/svg"
                  />
                  <img
              ...
              >
                <picture>
                  <source
                    srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/instagram.svg`}
                    type="image/svg"
                  />
                  <img
              ...
              >
                <picture>
                  <source
                    srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/twitter.svg`}
                    type="image/svg"
                  />
                  <img
              ...
              >
                <picture>
                  <source
                    srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/linkedin.svg`}
                    type="image/svg"
                  />
                  <img
        ...
        <div className="flex flex-col gap-[1.438rem] items-center lg:col-span-2">
          <div className="flex flex-col gap-[1.438rem]">
            ...
            <div className="flex flex-wrap lg:justify-end justify-center gap-5 lg:col-span-2">
              <picture>
                <source
                  srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/casamada.svg`}
                  type="image/svg"
                />
                <img
              ...
              <picture>
                <source
                  srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/mastercard.svg`}
                  type="image/svg"
                />
                <img
              ...
              <picture>
                <source
                  srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/visacard.svg`}
                  type="image/svg"
                />
                <img
              ...
              <picture>
                <source
                  srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/applepay.svg`}
                  type="image/svg"
                />
                <img
              ...
              <picture>
                <source
                  srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/stcpay.svg`}
                  type="image/svg"
                />
                <img
          ...
          <div className="hidden xl:flex flex-col items-center">
            ...
            <div className="flex items-center gap-2 mt-[1.438rem]">
              ...
              >
                <picture className="rounded">
                  ...
                  <img
                    ...
                    alt="gogo motor"
                    className="w-[9.3rem] aspect-[16/5] cursor-pointer"
                  />
                </picture>
              </a>
              <a
              ...
              >
                <picture className="rounded">
                  <source
                    srcSet={`${process.env.NEXT_PUBLIC_Image_CDN_URL}/CMS/Common/app_gallery.png`}
                    type="image/png"
                  />
                  <img
