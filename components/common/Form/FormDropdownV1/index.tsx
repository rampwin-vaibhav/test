...
const FormDropdownV1 = forwardRef<
  FormDropdownService,
        ...
        render={({
          ...
          return (
            <div className="go-form-dropdown w-full flex flex-col">
              {labelText && (
                <label className="text-[12px] font-medium pb-[4px]">
                  {labelText}
                </label>
              )}
              <div className={`relative min-w-40 rounded-[8px]`} ref={divRef}>
                <div
                  className={`select-area ${
                    disabled ? '!bg-light-gray' : ''
                  }  !rounded-[8px] !border !border-[#484E50] !border-opacity-[30%] !h-[48px]`}
                  onClick={() =>
